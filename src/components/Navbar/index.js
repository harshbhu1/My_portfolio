    ...
    return (
      <Nav>
        <NavContainer className={isScroll ? "scrolled" : ""}>
          ...
          <ButtonContainer>
            <Button
              href="https://drive.google.com/file/d/10PkaQ0xGX_QNXw5kogFj5f0wlHpxkaAb/view?usp=sharing"
              target="blank"
            >
              RESUME
            </Button>
            <Button href="https://github.com/harshbhu1" target="blank">
              Github
            </Button>
            <Button
              href="https://www.linkedin.com/in/harsh-maurya-139069237/"
              target="blank"
            >
              LinkedIn
            </Button>
          ...
          {isOpen && (
            <MobileMenu isOpen={isOpen}>
              ...
              <MobileButtonContainer isOpen={isOpen}>
                ...
                <MobileButton
                  href="https://github.com/harshbhu1"
                  target="blank"
                >
                  Github
                </MobileButton>
